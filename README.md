...
* Make sure you've installed required dependencies: ```pip install -r requirements.txt```
* Run ```run_once.py``` and input username & password for superuser to initialize things
    ```
